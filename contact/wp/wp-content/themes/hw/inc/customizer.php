...
function twentysixteen_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'../../twentysixteen/inc/default'           => '../../twentysixteen/inc/default',
	...
	$wp_customize->add_setting( 'page_background_color', array(
		'../../twentysixteen/inc/default'           => $color_scheme[1],
	...
	$wp_customize->add_setting( 'link_color', array(
		'../../twentysixteen/inc/default'           => $color_scheme[2],
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
	) );
	...
	$wp_customize->add_setting( 'main_text_color', array(
		'../../twentysixteen/inc/default'           => $color_scheme[3],
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
	) );
	...
	$wp_customize->add_setting( 'secondary_text_color', array(
		'../../twentysixteen/inc/default'           => $color_scheme[4],
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
	) );
...
function twentysixteen_get_color_schemes() {
	 ...
	 *
	 * The default schemes include '../../twentysixteen/inc/default', 'dark', 'gray', 'red', and 'yellow'.
	 *
	 * @since Twenty Sixteen 1.0
	 *
	 * @param array $schemes {
