<?php get_header(); ?>
		...
		<div class="pankuzu">
			<ul class="clearfix">
				...
				<li><?php $terms = get_the_terms($post->ID, 'empty_cat'); foreach($terms as $term){ $term_name = $term->name; echo $term_name; break; }; ?></li>
			</ul>
		</div>
		<!--section-->
		...
		<section>
			...
			<div class="inner clearfix">
				<div class="casebox01">
					<h2><?php $terms = get_the_terms($post->ID, 'empty_cat'); foreach($terms as $term){ $term_name = $term->name; echo $term_name; break; }; ?></h2>
...
<p class="categ">カテゴリー：<?php echo get_the_term_list($post->ID, 'empty_cat'); ?></p>
